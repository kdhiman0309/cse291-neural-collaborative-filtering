...
class Dataset(object):
    ...
    def __init__(self, path, prep_data=False,count_per_user_test=2,count_per_user_validation=0,num_negatives_train=3,num_threads=1):
        ...
        self.item_features = self.load_file(path + ".itemfeatures_gensim.pkl")
        ...
        if prep_data:
            ...
            # self.train_data = self.loadPickle("train_data_pickle")
            self.add_item_features_info()
            self.pickleit(self.train_data,"train_data_pickle")
